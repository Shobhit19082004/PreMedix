...
with col1:
    ...
    PreMedix is a cutting-edge, AI-powered web application designed to <b>detect multiple diseases</b> with high accuracy.<br>
    It uses advanced machine learning and deep learning algorithms to <b>analyze user inputs</b> and <b>predict disease likelihood</b> quickly and efficiently.
    </p>
    """, unsafe_allow_html=True)
